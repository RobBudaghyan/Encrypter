...
public class RSA_Encrypt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_public_key = findViewById(R.id.input_public_key);
        ...
        share.setOnClickListener(v -> {
            if (!result_textview.getText().toString().equals("") && !result_textview.getText().toString().equals(getResources().getString(R.string.invalid_key_format))) {
    ...
    private boolean sharedPrefIsEmpty(){
        ...
        return prefs.getString("public_key", "").equals("");
    }
